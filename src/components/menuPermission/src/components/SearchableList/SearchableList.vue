<template>
  <div class="msl-searchable-list">
    ...
    >
        ...
        <div
          ...
          :class="{
            'msl-searchable-list__item--disabled':
              (option && option.disabled) || disabled || readOnly,
            [highlightClass]:
              highlightDiff && highlightedItemsMap[getValue(option)],
          }"
      ...
      <div v-if="groupProperty">
        <div v-for="groupKey in sortedGroupKeys" :key="groupKey">
      ...
      if (this.searchText != null && this.searchText !== "") {
        return this.availableItems.filter(
          function filterItem(item) {
            ...
            return (
              display &&
              display.toLowerCase().includes(this.searchText.toLowerCase())
            );
          }.bind(this)
        );
      }
